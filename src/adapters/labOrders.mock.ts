...
const CATALOG: LabPanel[] = [
  ...
  { id: "lp-vibrant-thyroid", name: "Full Thyroid Panel", vendor: "Vibrant America", category: "Thyroid", specimenType: "Serum", fasting: false, markers: ["TSH", "Free T4", "Free T3", "Reverse T3", "TPO Ab", "Tg Ab"], estPriceMinor: 0, turnaround: "Vendor confirmation required", group: "custom", description: "Practice-preferred thyroid panel. Current panel contents, pricing, availability, and ordering eligibility require verification." },
  ...
  { id: "lp-gut-zoomer", name: "Gut Zoomer", vendor: "Vibrant Wellness", category: "GI", specimenType: "Stool", fasting: false, markers: ["Microbial balance", "Pathogen signals", "Digestive markers", "Inflammation markers"], estPriceMinor: 0, turnaround: "Vendor confirmation required", group: "custom", description: "Practice-preferred comprehensive gut panel. Current analytes, price, and ordering eligibility require verification." },
  ...
  { id: "lp-vibrant-mycotoxin", name: "Mycotoxins Panel", vendor: "Vibrant America", category: "Environmental", specimenType: "Urine", fasting: false, markers: ["Mycotoxin metabolites"], estPriceMinor: 0, turnaround: "Vendor confirmation required", group: "custom", description: "Practice-preferred environmental exposure panel. Interpretation must be correlated with exposure history and clinical context." },
  { id: "lp-cyrex-autoimmune", name: "Autoimmune Reactivity Screen", vendor: "Cyrex Laboratories", category: "Autoimmune", specimenType: "Serum", fasting: false, markers: ["Panel-specific immune reactivity markers"], estPriceMinor: 0, turnaround: "Vendor confirmation required", group: "custom", description: "Panel selection and clinical utility require practitioner review; not a standalone diagnosis." },
