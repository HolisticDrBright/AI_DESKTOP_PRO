...
const summaries: Record<string, PatientSummary> = {
  ...
  "p-78435": {
    ...
    reasoning: {
      ...
      hypotheses: [
        { name: "Inflammatory burden", sub: "Contributing to fatigue, poor sleep", strength: 82 },
        { name: "Cortisol dysregulation", sub: "Contributing to sleep disruption", strength: 74 },
        { name: "Mitochondrial dysfunction", sub: "Contributing to low energy", strength: 68 },
      ],
      evidenceFor: [
