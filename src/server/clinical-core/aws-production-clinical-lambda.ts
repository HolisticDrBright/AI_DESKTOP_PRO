...
import { createAwsProductionClinicalApiHandler } from "./aws-production-clinical-api";
...
export const handler = createAwsProductionClinicalApiHandler({
  adapter: createAwsProductionDesktopAdapter(database),
  configuration: {
