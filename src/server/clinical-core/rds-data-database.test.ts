...
describe("Aurora RDS Data API transaction adapter", () => {
  ...
  test.each([
    ...
    ["recording_consent_required", "consent_required"],
    ["recording_consent_release_required", "consent_required"],
    ["recording_capture_release_required", "consent_required"],
    ["recording_roster_required", "consent_required"],
    ["recording_storage_release_required", "consent_required"],
    ["recording_segment_conflict", "conflict"],
    ["recording_segment_order_required", "conflict"],
    ["recording_reservation_expired", "conflict"],
    ["recording_segment_invalid", "request_invalid"],
    ["recording_size_limit", "request_invalid"],
    ["recording_lifecycle_conflict", "conflict"],
    ["recording_inventory_changed", "conflict"],
    ["recording_segments_unresolved", "conflict"],
    ["recording_lifecycle_invalid", "request_invalid"],
    ["recording_participant_conflict", "conflict"],
    ["recording_consent_conflict", "conflict"],
    ["recording_capture_conflict", "conflict"],
    ["recording_consent_already_granted", "conflict"],
    ["recording_disposition_required", "conflict"],
    ["recording_encounter_closed", "conflict"],
    ["recording_participant_invalid", "request_invalid"],
    ["recording_participant_limit", "request_invalid"],
    ["recording_consent_invalid", "request_invalid"],
    ["recording_capture_invalid", "request_invalid"],
    ["recording_workspace_invalid", "request_invalid"],
    ...
    ["recording_cleanup_legal_hold", "legal_hold"],
    ["recording_legal_hold", "legal_hold"],
    ["recording_transcription_refused", "operation_refused"],
    ["recording_transcript_missing", "operation_refused"],
    ...
    ["recording_drafting_release_refused", "operation_refused"],
    ["recording_drafting_conflict", "conflict"],
    ["recording_transcript_superseded", "conflict"],
    ["recording_drafting_invalid", "request_invalid"],
    ...
    ["privacy_correction_resolution_invalid", "request_invalid"],
    ["privacy_correction_invalid", "request_invalid"],
    ["privacy_correction_not_applied", "conflict"],
    ["privacy_correction_target_changed", "conflict"],
    ["privacy_correction_resolution_conflict", "conflict"],
    ["personal_purge_policy_required", "identity_refused"],
    ["retention_policy_required", "identity_refused"],
    ["personal_purge_preview_changed", "conflict"],
    ["personal_purge_command_conflict", "conflict"],
    ["personal_purge_verification_failed", "conflict"],
    ["privacy_request_personal_store_changed", "conflict"],
