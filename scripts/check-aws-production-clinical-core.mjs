...
assert(manifest.migrations.length === 102, "expected ten transformed migrations and ninety-two production overlays");
...
assert(manifest.migrations.at(-1)?.file === '20260922010000_production_record_source_regime.sql', "record source-regime overlay must be last");
