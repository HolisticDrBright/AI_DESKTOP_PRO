...
if (-not $env:CLINICAL_WORKFORCE_ID_TOKEN -or -not $env:CLINICAL_CONSUMER_ID_TOKEN) {
  throw "Fresh workforce and consumer Cognito ID tokens must be set in this PowerShell process only."
}
