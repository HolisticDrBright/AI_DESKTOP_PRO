...
if (committed.counts?.productionImplemented !== 101 || committed.counts?.productionEnabled !== 0) {
  errors.push("production operation evidence must show ninety-two implemented core operations and zero enabled operations");
}
...
if (errors.length) {
  ...
  console.log(`Desktop operation inventory passed: 223 live operations, 101 implemented but activation-blocked, 0 enabled; ${providerBound} require provider-specific rewrites.`);
}
