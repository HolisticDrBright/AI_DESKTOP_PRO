...
if (committed.counts?.productionImplemented !== 46 || committed.counts?.productionEnabled !== 0) {
  errors.push("production operation evidence must show forty-six implemented core operations and zero enabled operations");
}
...
if (errors.length) {
  ...
  console.log(`Desktop operation inventory passed: 222 live operations, 46 implemented but activation-blocked, 0 enabled; ${providerBound} require provider-specific rewrites.`);
}
