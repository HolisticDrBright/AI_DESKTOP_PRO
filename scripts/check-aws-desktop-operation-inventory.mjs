...
if (committed.counts?.productionImplemented !== 86 || committed.counts?.productionEnabled !== 0) {
...
if (errors.length) {
  ...
  console.log(`Desktop operation inventory passed: 223 live operations, 86 implemented but activation-blocked, 0 enabled; ${providerBound} require provider-specific rewrites.`);
}
