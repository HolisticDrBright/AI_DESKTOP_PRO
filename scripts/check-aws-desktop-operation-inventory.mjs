...
if (committed.counts?.productionImplemented !== 92 || committed.counts?.productionEnabled !== 0) {
...
if (errors.length) {
  ...
  console.log(`Desktop operation inventory passed: 223 live operations, 92 implemented but activation-blocked, 0 enabled; ${providerBound} require provider-specific rewrites.`);
}
