...
if (committed.counts?.productionImplemented !== 188 || committed.counts?.productionEnabled !== 0) {
  errors.push("production operation evidence must show one hundred eighty-eight implemented core operations and zero enabled operations");
}
...
if (errors.length) {
  ...
  console.log(`Desktop operation inventory passed: 223 live operations, 188 implemented but activation-blocked, 0 enabled; ${providerBound} require provider-specific rewrites.`);
}
